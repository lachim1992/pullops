...
export const ENDPOINT_KINDS: EndpointKindInfo[] = [
  { value: "WORKSTATION",    label: "Pracoviště / PC", color: "hsl(210 80% 50%)",  icon: Monitor,     group: "device" },
  ...
  { value: "SOCKET",         label: "Datová zásuvka", color: "hsl(260 55% 55%)",  icon: Plug,        group: "outlet" },
  { value: "TRUNK_STRIP",    label: "Lišta",           color: "hsl(280 50% 55%)",  icon: PanelTop,    group: "outlet" },
  ...
  { value: "OUTDOOR_KIOSK",  label: "Venkovní kiosek", color: "hsl(90 45% 45%)",   icon: Warehouse,   group: "outdoor" },
  { value: "OUTDOOR_CABLE",  label: "Venkovní kabel",  color: "hsl(120 40% 45%)",  icon: Waves,       group: "outdoor" },
...
export const ENDPOINT_KIND_GROUPS: Array<{ id: string; label: string; kinds: EndpointKindInfo[] }> = [
  ...
  { id: "outlet",  label: "Zásuvky / místa", kinds: ENDPOINT_KINDS.filter((k) => k.group === "outlet") },
  { id: "outdoor", label: "Venkovní",        kinds: ENDPOINT_KINDS.filter((k) => k.group === "outdoor") },
